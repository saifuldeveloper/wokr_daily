                    ...
                    <div class="bg-white redious-border p-20 p-sm-30">
                        ...
                        <div class="row gx-20">
                                <div class="col-lg-12 input_file_div mb-4">
                                    ...
                                    <div class="selected-files d-flex flex-wrap gap-20">
                                        <div class="selected-files-item">
                                            <img class="selected-img" src="{{ getFileLink('original_image',setting('light_logo')) }}" alt="light_logo">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 input_file_div">
                                    ...
                                    <div class="selected-files d-flex flex-wrap gap-20">
                                        <div class="selected-files-item">
                                            <img class="selected-img" src="{{ getFileLink('original_image',setting('dark_logo')) }}" alt="dark_logo">
                                        </div>
                                    </div>
                                </div>
