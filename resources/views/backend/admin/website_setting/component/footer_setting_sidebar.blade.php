<ul class="nav pb-12 mb-20" id="pills-tab" role="tablist">
    <li class="nav-item" role="presentation">
        <a href="{{ route('footer.social-links') }}" class="nav-link ps-0 {{ request()->routeIs('footer.social-links') ? 'active' : '' }}">
            <span>{{ __('social_links') }}</span>
        </a>
    </li>
    <li class="nav-item" role="presentation">
        <a href="{{ route('footer.newsletter-settings') }}" class="nav-link ps-0 {{ request()->routeIs('footer.newsletter-settings') ? 'active' : '' }}">
    ...
    <li class="nav-item" role="presentation">
        <a href="{{ route('footer.resource-links') }}" class="nav-link ps-0 {{ request()->routeIs('footer.resource-links') ? 'active' : '' }}">
    ...
    <li class="nav-item" role="presentation">
        <a href="{{ route('footer.apps-links') }}" class="nav-link ps-0 {{ request()->routeIs('footer.apps-links') ? 'active' : '' }}">
