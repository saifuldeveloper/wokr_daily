                    ...
                    <div class="bg-white redious-border p-20 p-sm-30">
                        ...
                        <form action="{{ route('gdpr') }}" method="POST" class="form">@csrf
                            <div class="row gx-20">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        <label for="cookies_agreement" class="form-label">{{ __('cookies_agreement_text') }}</label>
                                        <textarea class="form-control" id="cookies_agreement"
                                                  name="cookies_agreement" placeholder="{{ __('enter_cookies_agreement_text') }}">{{ setting('cookies_agreement',$lang) }}</textarea>
                                        <div class="nk-block-des text-danger">
                                            <p class="cookies_agreement_error error">{{ $errors->first('lang') }}</p>
                                        </div>
                                    </div>
                                </div>
