                        ...
                        @foreach($sections as $key=> $section)
                                ...
                                <div class="accordion-item" data-type="top_courses" id="top_courses">
                                    <h2 class="accordion-header" id="topCourse">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                data-bs-target="#top_courses_section_{{$i}}" aria-expanded="true" aria-controls="topCourseCollapse">
                                    ...
                                    <div id="top_courses_section_{{$i}}" class="accordion-collapse collapse" aria-labelledby="topCourse"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control rounded-2" data-type="title" value="{{ arrayCheck('title',$section->contents) ? $section->contents['title'] : '' }}" name="builder[top_courses_{{$i}}][title]" id="courseTitle" placeholder="{{ __('enter_title') }}">
                                                    </div>
                                                </div>
                                                <!-- End Section Title -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="">
                                                        ...
                                                        <textarea name="builder[top_courses_{{$i}}][sub_title]" class="form-control h-80" data-type="sub_title" id="courseSubtitle" placeholder="{{ __('enter_sub_title') }}">{{ arrayCheck('sub_title',$section->contents) ? $section->contents['sub_title'] : '' }}</textarea>
                                                    </div>
                                                </div>
                            ...
                            @if($section->section == 'success_story')
                                ...
                                <div class="accordion-item" data-type="success_story" id="success_story">
                                    ...
                                    <div id="success_story_section_{{$i}}" class="accordion-collapse collapse" aria-labelledby="successStory"
                                         data-bs-parent="#homepageContent">
                                    </div>
                                </div>
                            @endif
                            @if($section->section == 'counter_section')
                                ...
                                <div class="accordion-item" data-type="counter_section" id="counter_section">
                                    ...
                                    <div id="counter_section_{{$i}}" class="accordion-collapse collapse" aria-labelledby="successStory"
                                         data-bs-parent="#homepageContent">
                                    </div>
                                </div>
                            @endif
                            @if($section->section == 'fun_fact')
                                ...
                                <div class="accordion-item" data-type="funFact" id="fun_fact">
                                    <h2 class="accordion-header" id="funFact">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                data-bs-target="#funFactCollapse_{{$i}}" aria-expanded="false" aria-controls="funFactCollapse">
                                            <img src="{{ static_asset('admin/img/icons/maximize.svg')}}" alt="maximize">
                                            <span>{{ __('fun_fact') }}</span>
                                        </button>
                                        <a href="javascript:void(0)" class="delete-icon"><i class="las la-trash-alt"></i></a>
                                    </h2>
                                    <div id="funFactCollapse_{{$i}}" class="accordion-collapse collapse" aria-labelledby="funFact"
                                         data-bs-parent="#homepageContent">
                                        <div class="accordion-body">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control rounded-2" id="funFactTitle" data-type="title" name="builder[fun_fact_{{$i}}][title]"
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[fun_fact_{{$i}}][sub_title]"
                            ...
                            @if($section->section == 'subject')
                                ...
                                <div class="accordion-item" data-type="subject" id="subject">
                                    <h2 class="accordion-header" id="subjects">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                data-bs-target="#subject_section_{{$i}}" aria-expanded="false" aria-controls="subjectCollapse">
                                            <img src="{{ static_asset('admin/img/icons/maximize.svg')}}" alt="maximize">
                                            <span>{{ __('subject') }}</span>
                                        </button>
                                        <a href="javascript:void(0)" class="delete-icon"><i class="las la-trash-alt"></i></a>
                                    </h2>
                                    <div id="subject_section_{{$i}}" class="accordion-collapse collapse" aria-labelledby="subjects"
                                         data-bs-parent="#homepageContent">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control rounded-2" id="subjectTitle" data-type="title" name="builder[subject_{{$i}}][title]"
                                                               placeholder="{{ __('enter_title') }}" value="{{ arrayCheck('title',$section->contents) ? $section->contents['title'] : '' }}">
                                                    </div>
                                                </div>
                                                <!-- End Section Title -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[subject_{{$i}}][sub_title]"
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="multi-select-v2">
                                                        ...
                                                        <select multiple class="form-select rounded-0 mb-3" placeholder="{{ __('select_subjects') }}" name="builder[subject_{{$i}}][ids][]">
...
{{--                            @endif--}}
                            @if($section->section == 'instructors')
                                ...
                                <div class="accordion-item" data-type="instructors" id="instructors">
                                    ...
                                    <div id="instructors_section_{{$i}}" class="accordion-collapse collapse" aria-labelledby="instructor"
                                         data-bs-parent="#homepageContent">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control rounded-2" data-type="title" id="instructorTitle" name="builder[instructors_{{$i}}][title]"
                                                               placeholder="{{ __('enter_title') }}" value="{{ arrayCheck('title',$section->contents) ? $section->contents['title'] : '' }}">
                                                    </div>
                                                </div>
                                                <!-- End Section Title -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea name="builder[instructors_{{$i}}][sub_title]" data-type="sub_title" class="form-control h-80" placeholder="{{ __('enter_sub_title') }}"
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="multi-select-v2">
                                                        <select name="builder[instructors_{{$i}}][ids][]" multiple  placeholder="{{ __('select_instructor') }}"
                            ...
                            @if($section->section == 'lesson_with_mentor')
                                ...
                                <div class="accordion-item" data-type="lesson_with_mentor" id="lesson_with_mentor">
                                    <h2 class="accordion-header" id="mentor">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                data-bs-target="#lesson_with_mentor_section_{{$i}}" aria-expanded="false" aria-controls="mentorCollapse">
                                            <img src="{{ static_asset('admin/img/icons/maximize.svg')}}" alt="maximize">
                                            <span>{{ __('lesson_with_mentor') }}</span>
                                        </button>
                                        <a href="javascript:void(0)" class="delete-icon"><i class="las la-trash-alt"></i></a>
                                    </h2>
                                    <div id="lesson_with_mentor_section_{{$i}}" class="accordion-collapse collapse" aria-labelledby="mentor"
                                         data-bs-parent="#homepageContent">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control rounded-2" id="mentorTitle" data-type="title" name="builder[lesson_with_mentor_{{$i}}][title]"
                                                               placeholder="{{ __('enter_title') }}" value="{{ arrayCheck('title',$section->contents) ? $section->contents['title'] : '' }}">
                                                    </div>
                                                </div>
                                                <!-- End Section Title -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[lesson_with_mentor_{{$i}}][sub_title]"
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="multi-select-v2">
                                                        <select name="builder[lesson_with_mentor_{{$i}}][ids][]" multiple  placeholder="{{ __('select_lessons') }}"
                                                                class="form-select form-select-lg mb-3">
                            ...
                            @if($section->section == 'single_course')
                                ...
                                <div class="accordion-item" data-type="single_course" id="single_course">
                                    ...
                                    <div id="single_course_section_{{$i}}" class="accordion-collapse collapse" aria-labelledby="singleCourse"
                                         data-bs-parent="#homepageContent">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control rounded-2" id="singleCourseTitle"  data-type="title" name="builder[single_course_{{$i}}][title]"
                                                               placeholder="{{ __('enter_title') }}" value="{{ arrayCheck('title',$section->contents) ? $section->contents['title'] : '' }}">
                                                    </div>
                                                </div>
                                                <!-- End Section Title -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[single_course_{{$i}}][sub_title]"
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="multi-select-v2">
                                                        <select name="builder[single_course_{{$i}}][ids][]" multiple  placeholder="{{ __('select_course') }}"
                                                                class="form-select form-select-lg mb-3">
                            ...
                            @if($section->section == 'video_slider')
                                ...
                                <div class="accordion-item" data-type="video_slider" id="video_slider">
                                    ...
                                    <div id="video_slider_section_{{$i}}" class="accordion-collapse collapse" aria-labelledby="videoSlider"
                                         data-bs-parent="#homepageContent">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control rounded-2" id="videoSliderTitle" data-type="title" name="builder[video_slider_{{$i}}][title]"
                                                               placeholder="{{ __('enter_title') }}" value="{{ arrayCheck('title',$section->contents) ? $section->contents['title'] : '' }}">
                                                    </div>
                                                </div>
                                                <!-- End Section Title -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[video_slider_{{$i}}][sub_title]"
                                                ...
                                                <div class="col-12">
                                                    <div class="video-upload-link mb-30">
                                                        <label for="videoURL" class="form-label mb-1">Video URL</label>
                                                        <input type="url" name="builder[video_slider_{{$i}}][url]" class="form-control rounded-2" id="videoURL"
                                                               value="{{ arrayCheck('url',$section->contents) ? $section->contents['url'] : '' }}"
                                                               placeholder="https://">
                                                    </div>
                                                </div>
                                                <!-- End Video URL -->
                                                ...
                                                @include('backend.common.media-input',[
                                                    'title'         => __('fun_fact_image1'),
                                                    'name'          => "builder[video_slider_$i][image1]",
                                                    'col'           => 'col-lg-12 mb-4',
                                                    'size'          => '(296x285)',
                                                    'type'          => 'image1',
                                                    'image'         => old("builder[video_slider_$i][image1]"),
                                                    'label'         => __('image'),
                                                    'image_object'  => $section->image_1,
                                                    'media_id'      => $section->media_id_1,
                                                    'edit'          => true,
                            ...
                            @if($section->section == 'featured_course')
                                ...
                                <div class="accordion-item" data-type="featured_course" id="featured_course">
                                    ...
                                    <div id="featured_course_section_{{$i}}" class="accordion-collapse collapse" aria-labelledby="featuredCourse"
                                         data-bs-parent="#homepageContent">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control rounded-2" id="featuredCourseTitle" data-type="title" name="builder[featured_course_{{$i}}][title]"
                                                               placeholder="{{ __('enter_title') }}" value="{{ arrayCheck('title',$section->contents) ? $section->contents['title'] : '' }}">
                                                    </div>
                                                </div>
                                                <!-- End Section Title -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[featured_course_{{$i}}][sub_title]"
                                                ...
                                                <div class="col-lg-12">
                                                    <label class="form-label">{{ __('select_course') }}</label>
                                                    <div class="multi-select-v2">
                                                        <select name="builder[featured_course_{{$i}}][ids][]" data-is_featured="1"   placeholder="{{ __('select_course') }}"
                            ...
                            @if($section->section == 'blog_news')
                                ...
                                <div class="accordion-item" data-type="blog_news" id="blog_news">
                                    <h2 class="accordion-header" id="blogNews">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                data-bs-target="#blog_news_section_{{$i}}" aria-expanded="false" aria-controls="blogNewsCollapse">
                                            <img src="{{ static_asset('admin/img/icons/maximize.svg')}}" alt="maximize">
                                            <span>{{ __('blog_news') }}</span>
                                        </button>
                                        <a href="javascript:void(0)" class="delete-icon"><i class="las la-trash-alt"></i></a>
                                    </h2>
                                    <div id="blog_news_section_{{$i}}" class="accordion-collapse collapse" aria-labelledby="blogNews"
                                         data-bs-parent="#homepageContent">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control rounded-2" id="blogNewsTitle" data-type="title" name="builder[blog_news_{{$i}}][title]"
                                                               placeholder="{{ __('enter_title') }}" value="{{ arrayCheck('title',$section->contents) ? $section->contents['title'] : '' }}">
                                                    </div>
                                                </div>
                                                <!-- End Section Title -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="">
                                                        ...
                                                        <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[blog_news_{{$i}}][sub_title]"
                            ...
                            @if($section->section == 'testimonial')
                                ...
                                <div class="accordion-item" data-type="testimonial" id="testimonial">
                                    ...
                                    <div id="testimonial_section_{{$i}}" class="accordion-collapse collapse" aria-labelledby="testimonial"
                                         data-bs-parent="#homepageContent">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control rounded-2" id="testimonialTitle" data-type="title" name="builder[testimonial_{{$i}}][title]"
                                                               placeholder="{{ __('enter_title') }}" value="{{ arrayCheck('title',$section->contents) ? $section->contents['title'] : '' }}">
                                                    </div>
                                                </div>
                                                <!-- End Section Title -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[testimonial_{{$i}}][sub_title]"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control rounded-2" id="becomeInstructorTitle" data-type="title" name="builder[become_instructor_{{$i}}][title]"
                                                               placeholder="{{ __('enter_title') }}" value="{{ arrayCheck('title',$section->contents) ? $section->contents['title'] : '' }}">
                                                    </div>
                                                </div>
                                                <!-- End Section Title -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="">
                                                        ...
                                                        <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[become_instructor_{{$i}}][sub_title]"
                            ...
                            @if($section->section == 'partner_logo')
                                ...
                                <div class="accordion-item" data-type="partner_logo" id="partner_logo">
                                    ...
                                    <div id="partner_logo_section_{{$i}}" class="accordion-collapse collapse" aria-labelledby="partnerLogo"
                                         data-bs-parent="#homepageContent">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control rounded-2" id="partnerLogoTitle" data-type="title" name="builder[partner_logo_{{$i}}][title]"
                                                               placeholder="{{ __('enter_title') }}" value="{{ arrayCheck('title',$section->contents) ? $section->contents['title'] : '' }}">
                                                    </div>
                                                </div>
                                                <!-- End Section Title -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="">
                                                        ...
                                                        <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[partner_logo_{{$i}}][sub_title]"
                    ...
                    <div class="fixedSide">
                        ...
                        <div class="bg-white redious-border p-20 px-xl-3 py-xl-20 simplebar">
                            <div class="builder-content" id="builderContent">
                                ...
                                <div class="builder" data-target_id="fun_fact" data-name="fun_fact" data-var_type="array">
                                    <div class="icon">
...
{{--                                </div>--}}
                                ...
                                <div class="builder" data-target_id="instructors" data-name="instructors" data-var_type="array">
                                    <div class="icon">
                                ...
                                <div class="builder" data-target_id="blog_news" data-name="blog_news" data-var_type="array">
                                    <div class="icon">
                                ...
                                <div class="builder" data-target_id="testimonial" data-name="testimonial" data-var_type="array">
                                    <div class="icon">
                                ...
                                <div class="builder" data-target_id="partner_logo" data-name="partner_logo" data-var_type="array">
                                    <div class="icon">
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="courseTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" data-type="title" name="builder[top_courses]" id="courseTitle" placeholder="{{ __('enter_title') }}">
                                </div>
                            </div>
                            <!-- End Section Title -->
                            ...
                            <div class="col-lg-12">
                                <div class="">
                                    <label for="courseSubtitle" class="form-label">{{ __('subtitle') }}</label>
                                    <textarea name="builder[top_courses]" class="form-control h-80" data-type="sub_title" id="courseSubtitle" placeholder="{{ __('enter_sub_title') }}"></textarea>
                                </div>
                            </div>
                            <!-- End Section Subtitle -->
                        </div>
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="funFactTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" id="funFactTitle" data-type="title" name="builder[fun_fact]"
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="funFactSubtitle" class="form-label">{{ __('subtitle') }}</label>
                                    <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[fun_fact]"
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="subjectTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" id="subjectTitle" data-type="title" name="builder[subject]"
                                           placeholder="{{ __('enter_title') }}">
                                </div>
                            </div>
                            <!-- End Section Title -->
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="subjectSubtitle" class="form-label">{{ __('subtitle') }}</label>
                                    <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[subject]"
                            ...
                            <div class="col-lg-12">
                                <div class="multi-select-v2">
                                    <label class="form-label">{{ __('select_subject') }}</label>
                                    <select multiple class="form-select rounded-0 mb-3" placeholder="{{ __('select_subjects') }}"  name="builder[subject]">
                                    </select>
                                </div>
                            </div>
                            <!-- End Subject -->
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="serviceTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" id="serviceTitle" data-type="title" name="builder[service_pricing]"
                                           placeholder="{{ __('enter_title') }}">
                                </div>
                            </div>
                            <!-- End Section Title -->
                            ...
                            <div class="col-lg-12">
                                <div class="">
                                    <label for="serviceSubtitle" class="form-label">{{ __('subtitle') }}</label>
                                    <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[service_pricing]"
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="instructorTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" data-type="title" id="instructorTitle" name="builder[instructors]"
                                           placeholder="{{ __('enter_title') }}">
                                </div>
                            </div>
                            <!-- End Section Title -->
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="instructorSubtitle" class="form-label">{{ __('subtitle') }}</label>
                                    <textarea name="builder[instructors]" data-type="sub_title" class="form-control h-80" placeholder="{{ __('enter_sub_title') }}"
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="mentorTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" id="mentorTitle" data-type="title" name="builder[lesson_with_mentor]"
                                           placeholder="{{ __('enter_title') }}">
                                </div>
                            </div>
                            <!-- End Section Title -->
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="mentorSubtitle" class="form-label">{{ __('subtitle') }}</label>
                                    <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[lesson_with_mentor]"
                            ...
                            <div class="col-lg-12">
                                <label class="form-label">{{ __('select_lessons') }}</label>
                                <div class="multi-select-v2">
                                    <select name="builder[lesson_with_mentor]" multiple  placeholder="{{ __('select_lessons') }}"
                                            class="form-select form-select-lg mb-3"></select>
                                </div>
                            </div>
                            <!-- End Mentor -->
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="singleCourseTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" id="singleCourseTitle"  data-type="title" name="builder[single_course]"
                                           placeholder="{{ __('enter_title') }}">
                                </div>
                            </div>
                            <!-- End Section Title -->
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="singleCourseSubtitle" class="form-label">{{ __('subtitle') }}</label>
                                    <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[single_course]"
                            ...
                            <div class="col-lg-12">
                                <label class="form-label">{{ __('select_course') }}</label>
                                <div class="multi-select-v2">
                                    <select name="builder[single_course]" multiple  placeholder="{{ __('select_course') }}"
                                            class="form-select form-select-lg mb-3"></select>
                                </div>
                            </div>
                            <!-- End Single Course -->
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="videoSliderTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" id="videoSliderTitle" data-type="title" name="builder[video_slider]"
                                           placeholder="{{ __('enter_title') }}">
                                </div>
                            </div>
                            <!-- End Section Title -->
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="videoSliderSubtitle" class="form-label">{{ __('subtitle') }}</label>
                                    <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[video_slider]"
                            ...
                            <div class="col-12">
                                <div class="video-upload-link mb-30">
                                    <label for="videoURL" class="form-label mb-1">Video URL</label>
                                    <input type="url" data-type="url" name="builder[video_slider]" class="form-control rounded-2" id="videoURL"
                                           placeholder="https://">
                                </div>
                            </div>
                            <!-- End Video URL -->
                            ...
                            @include('backend.common.media-input',[
                                                    ...
                                                    'size'  => '(296x285)',
                                                    'type'  => 'image1',
                                                    'image' => old("builder[video_slider]"),
                                                    'label' => __('image'),
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="featuredCourseTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" id="featuredCourseTitle" data-type="title" name="builder[featured_course]"
                                           placeholder="{{ __('enter_title') }}">
                                </div>
                            </div>
                            <!-- End Section Title -->
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="featuredCourseSubtitle" class="form-label">{{ __('subtitle') }}</label>
                                    <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[featured_course]"
                            ...
                            <div class="col-lg-12">
                                <label class="form-label">{{ __('select_course') }}</label>
                                <div class="multi-select-v2">
                                    <select name="builder[featured_course]" data-is_featured="1"   placeholder="{{ __('select_course') }}"
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="blogNewsTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" id="blogNewsTitle" data-type="title" name="builder[blog_news]"
                                           placeholder="{{ __('enter_title') }}">
                                </div>
                            </div>
                            <!-- End Section Title -->
                            ...
                            <div class="col-lg-12">
                                <div class="">
                                    <label for="blogNewsSubtitle" class="form-label">{{ __('subtitle') }}</label>
                                    <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[blog_news]"
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="testimonialTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" id="testimonialTitle" data-type="title" name="builder[testimonial]"
                                           placeholder="{{ __('enter_title') }}">
                                </div>
                            </div>
                            <!-- End Section Title -->
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="testimonialSubtitle" class="form-label">{{ __('subtitle') }}</label>
                                    <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[testimonial]"
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="becomeInstructorTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" id="becomeInstructorTitle" data-type="title" name="builder[become_instructor]"
                                           placeholder="{{ __('enter_title') }}">
                                </div>
                            </div>
                            <!-- End Section Title -->
                            ...
                            <div class="col-lg-12">
                                <div class="">
                                    <label for="becomeInstructorSubtitle"
                                           class="form-label">{{ __('subtitle') }}</label>
                                    <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[become_instructor]"
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="partnerLogoTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" id="partnerLogoTitle" data-type="title" name="builder[partner_logo]"
                                           placeholder="{{ __('enter_title') }}">
                                </div>
                            </div>
                            <!-- End Section Title -->
                            ...
                            <div class="col-lg-12">
                                <div class="">
                                    <label for="partnerLogoSubtitle" class="form-label">{{ __('subtitle') }}</label>
                                    <textarea class="form-control h-80" placeholder="{{ __('enter_sub_title') }}" data-type="sub_title" name="builder[partner_logo]"
