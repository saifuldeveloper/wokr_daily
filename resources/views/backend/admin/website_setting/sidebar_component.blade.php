    ...
    <div class="bg-white redious-border py-3 py-sm-30 mb-30">
        <div class="email-tamplate-sidenav">
            <ul class="default-sidenav">
                <li>
                    <a href="{{ route('website.themes') }}" class="{{ request()->routeIs('website.themes') ? 'active' : '' }}">
                        <span class="icon"><i class="las la-feather"></i></span>
                        <span>{{ __('website_themes') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('theme.options') }}" class="{{ request()->routeIs('theme.options') ? 'active' : '' }}">
                        <span class="icon"><i class="las la-palette"></i></span>
                        <span>{{ __('theme_options') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('header.logo') }}" class="{{ request()->routeIs('header.logo') || request()->routeIs('header.topbar') || request()->routeIs('header.menu') ? 'active' : '' }}">
                        <span class="icon"><i class="las la-heading"></i></span>
                        <span>{{ __('header_content') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('hero.section') }}" class="{{ request()->routeIs('hero.section') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('website.cta') }}" class="{{ request()->routeIs('website.cta') ? 'active' : '' }}">
                        <span class="icon"><i class="las la-memory"></i></span>
                ...
                <li>
                    <a href="{{ route('website.popup') }}" class="{{ request()->routeIs('website.popup') ? 'active' : '' }}">
                        <span class="icon"><i class="las la-sticky-note"></i></span>
                        <span>{{ __('website_popup') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('website.seo') }}" class="{{ request()->routeIs('website.seo') ? 'active' : '' }}">
                        <span class="icon"><i class="las la-bullhorn"></i></span>
                        <span>{{ __('website_seo') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('custom.js') }}" class="{{ request()->routeIs('custom.js') ? 'active' : '' }}">
                        <span class="icon"><i class="lab la-js-square"></i></span>
                        <span>{{ __('custom_js') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('website.instructor_content') }}" class="{{ request()->routeIs('website.instructor_content') ? 'active' : '' }}">
                        <span class="icon"><i class="lab la-js-square"></i></span>
                        <span>{{ __('instructor_content') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('custom.css') }}" class="{{ request()->routeIs('custom.css') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('google.setup') }}" class="{{ request()->routeIs('google.setup') ? 'active' : '' }}">
