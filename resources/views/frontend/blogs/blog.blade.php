                        ...
                        <div class="blog-sidebar m-t-md-30">
                            <div class="widget widget-checklist">
                                ...
                                <ul class="widget-list-group">
                                    <li>
                                        <label>
                                            <input type="checkbox" name="all_blog" class="filtering_btn categories_btn"
                                                   value="1">
                                    ...
                                    @foreach($blog_categories as $key => $categories)
                                        <li>
                                            <label>
                                                <input type="checkbox" class="filtering_btn categories_btn"
                            ...
                            <div class="col-lg-4 col-sm-6" data-aos="fade-up"
                                ...
                                <div class="blog-post-item">
                                    <div class="post-thumbnail">
                                        ...
                                        <ul class="post-meta">
                                            <li class="date"><a
                                                    href="{{route('blog-details',['slug'=>$featured_blog->slug])}}"><i
                                        ...
                                        <div class="post-meta-wrapper">
                                            <div class="left-content">
                                                <ul class="post-meta">
                                                    ...
                                                    <li><a href="#"><i class="fal fa-user"></i>
