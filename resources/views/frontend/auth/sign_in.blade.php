                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-xl-5 col-lg-8 col-md-8">
                        <div class="user-form-container m-t-40 m-t-sm-0">
                            ...
                            @if(isDemoMode())
                                <div class="demo_login_btn">
                                    <div class="mb-1">
                                        <a href="javascript:void(0)" class="template-btn pt-2 pb-2" data-type="admin">{{ __('admin') }}</a>
                                        <a href="javascript:void(0)" class="template-btn pt-2 pb-2" data-type="instructor">{{ __('instructor') }}</a>
                                    </div>
                                    <div class="mb-1">
                                        <a href="javascript:void(0)" class="template-btn pt-2 pb-2" data-type="student">{{ __('student') }}</a>
                                        <a href="javascript:void(0)" class="template-btn pt-2 pb-2" data-type="staff">{{ __('staff') }}</a>
                                    </div>
                                    <div class="mb-1 text-align-center">
                                        <a href="javascript:void(0)" class="template-btn pt-2 pb-2" data-type="organization">{{ __('organization') }}</a>
                                    </div>
                                </div>
                            @endif
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click','.demo_login_btn a', function () {
                ...
                $('.demo_login_btn').addClass('d-none');
