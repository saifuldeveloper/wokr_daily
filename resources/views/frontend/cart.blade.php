                        ...
                        <table class="table align-middle" style="min-width: 1000px;">
                            ...
                            @forelse($carts['courses'] as $course)
                                <tr>
                                    ...
                                    <td>{{ $course->is_free ? __('free') : get_price($course->price) }}</td>
                                    <td class="text-end">
                ...
                <div class="col-lg-4 col-md-5 col-sm-6">
                    <div class="cart-product-calculation">
                        <table class="table">
                            ...
                            <tr>
                                <td>{{ __('sub_total') }}</td>
                                <td class="sub_total">{{ get_price($user_carts->sum('sub_total')) }}</td>
                            </tr>
                            <tr>
                                <td>{{ __('discount') }}</td>
                            ...
                            @if(auth()->check() && setting('coupon_system'))
                                <tr>
                                    ...
                                    <td class="coupon_discount">{{ get_price($coupons->sum('coupon_discount')) }}</td>
                                </tr>
                            @endif
                            <tr>
                                <td>{{__('total')}}</td>
                                <td class="total">{{ get_price($user_carts->sum('total_amount') - $total_discount) }}</td>
                            </tr>
