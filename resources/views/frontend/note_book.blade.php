...
@section('content')
<!--====== Start Note Book Section ======-->
<section class="note-book-section p-t-50 p-t-sm-30 p-b-50">
    <div class="container container-1278">
        <div class="row">
            <div class="col-lg-8">
                <div class="row">
                    <div class="col-12">
                        <div class="border-bottom-soft-white-lg p-b-md-10 m-b-25 m-b-sm-15 fw-medium fz-22">
                            <h3>SSC Animated Lessons</h3>
                        </div>
                    </div>
                </div>
                <div class="note-book-wrapper">
                    <img src="assets/img/books/notebook/notebook.png" alt="Notebook">
                </div>
            </div>
            <div class="col-lg-4">
