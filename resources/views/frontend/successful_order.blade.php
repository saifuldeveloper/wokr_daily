                        ...
                        <table class="table table-v2 align-middle" style="min-width: 700px;">
                            ...
                            @foreach($checkout->enrolls as $enroll)
                                <tr>
                                    ...
                                    @endif
                                    <td>{{ get_price($enroll->price) }}</td>
                                    <td>{{ $enroll->quantity }}</td>
                                    <td>{{ get_price($enroll->sub_total) }}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
                ...
                <div class="col-lg-4 col-md-5 col-sm-6">
                    <div class="cart-product-calculation">
                        <table class="table">
                            ...
                            <tr>
                                <td>{{__('subtotal')}}</td>
                                <td>{{ get_price($checkout->sub_total) }}</td>
                            </tr>
<!--                            <tr>
                                <td>Tax</td>
                                <td>{{ get_price($checkout->tax) }}</td>
                            </tr>-->
                            <tr>
                                <td>{{__('discount')}}</td>
                                <td>{{ get_price($checkout->discount) }}</td>
                            </tr>
<!--                            <tr>
                                <td>Shipping Cost</td>
                                <td>{{ get_price($checkout->shipping_cost) }}</td>
                            </tr>-->
                            <tr>
                                <td>{{__('coupon_discount')}}</td>
                                <td>{{ get_price($checkout->coupon_discount) }}</td>
                            </tr>
                            <tr>
                                <td>{{__('total')}}</td>
                                <td>{{ get_price($checkout->payable_amount) }}</td>
                            </tr>
                            </tbody>
                        </table>
