...
class WebsiteSettingController extends Controller
{
    ...
    public function updateHomePage(Request $request): \Illuminate\Http\JsonResponse
    {
        if (isDemoMode()) {
            $data = [
                'status' => 'danger',
        ...
        try {
            ...
            foreach ($request->builder as $key => $builder) {
                ...
                $home_screen = HomeScreen::where('type', 'home_page')->where('section', $section)->first();
    ...
    public function updateThemes(Request $request): \Illuminate\Http\JsonResponse
    {
        if (isDemoMode()) {
            $data = [
                'status' => 'danger',
    ...
    public function savePopupSetting(Request $request): \Illuminate\Http\JsonResponse
    {
        if (isDemoMode()) {
            $data = [
                'status' => 'danger',
    ...
    public function saveCtaSetting(Request $request): \Illuminate\Http\JsonResponse
    {
        if (isDemoMode()) {
            $data = [
                'status' => 'danger',
    ...
    public function saveInstructorContent(Request $request): \Illuminate\Http\JsonResponse
    {
        if (isDemoMode()) {
            $data = [
                'status' => 'danger',
    ...
    public function saveGdpr(Request $request): \Illuminate\Http\JsonResponse
    {
        if (isDemoMode()) {
            $data = [
                'status' => 'danger',
