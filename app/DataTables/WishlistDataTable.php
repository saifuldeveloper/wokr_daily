...
class WishlistDataTable extends DataTable
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('course_title')->title(__('course_title'))->exportable(false)->printable(false)
                ->searchable(false),
            Column::computed('category')->title(__('category'))->exportable(false)->printable(false)
                ->searchable(false),
            Column::computed('organization')->title(__('organization'))->exportable(false)->printable(false)
                ->searchable(false),
